      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 text-sm max-w-md">
              The premier platform for betting on esports tournaments. Join the community, place bets on matches, and win rewards.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/bets" className="text-gray-400 hover:text-white text-sm">
                  Betting
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} EsportsBets. All rights reserved.
          </p>
