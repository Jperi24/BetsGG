...
const authLimiter = rateLimit({
  ...
  max: 20, // limit each IP to 10 attempts per hour
...
const financialLimiter = rateLimit({
  windowMs: 60 * 60 * 1000, // 1 hour
  max: 100, // limit each IP to 20 financial operations per hour
...
const bettingLimiter = rateLimit({
  windowMs: 15 * 60 * 1000, // 15 minutes
  max: 150, // limit each IP to 30 bet placements per 15 minutes
